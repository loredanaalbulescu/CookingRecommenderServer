...
class BadgesControllerTest < ActionController::TestCase
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post :create, badge: { description: @badge.description, name: @badge.name, picture: @badge.picture, score: @badge.score }
    end
  ...
  test "should update badge" do
    patch :update, id: @badge, badge: { description: @badge.description, name: @badge.name, picture: @badge.picture, score: @badge.score }
    assert_redirected_to badge_path(assigns(:badge))
  end
